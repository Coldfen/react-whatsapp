...
import recordAudio from "../../../HOC/recordAudio";
...
interface ChatFooterProps {
    ...
    image: File | Blob
    user: firebase.User
    room: { id: string; photoURL: string; name?: string; }
    roomId: string
 ...
 const ChatFooter:FC<ChatFooterProps> = ({
  ...
  const [ duration, setDuration ] = useState<string>("00:00")
     ...
     const recordingEl = useRef<HTMLDivElement>(null)
     ...
     useEffect(() => {
         ...
         function startTimer() {
             ...
             function setTime() {
                 ...
                 const minutes = pad(parseInt(String(totalSeconds / 60)))
                 const seconds = pad(parseInt(String(totalSeconds % 60)))
